...
public class CategoryController {
    ...
    public ResponseEntity<List<CategoryDto>> searchCategoryByTitle(@PathVariable("keywords") String keywords) {
        List<CategoryDto> filteredCategoryDto = categoryService.searchCategory(keywords);
